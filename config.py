...
LIST_TYPE_OUTILS = ["SANS OUTIL", "TRAVAUX SOL POINTES", "TRAVAUX SOL CHARRUES", "TRAVAUX SOL DISQUES", "TRAVAUX SOL ROTAVATOR", 
...
PARTIE_TRAVAILLE_PAR_LOUTIL = ["RANG", "INTERCEP", "LA PARCELLE"]
